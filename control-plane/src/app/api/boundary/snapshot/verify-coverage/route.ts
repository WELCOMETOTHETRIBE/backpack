/**
 * GET /api/boundary/snapshot/verify-coverage?snapshot_id=...
 * Recomputes coverage hash for the snapshot and returns verified or hash_mismatch.
 */
...
export async function GET(req: Request) {
  try {
    ...
    const snapshotId = new URL(req.url).searchParams.get("snapshot_id")?.trim() || undefined;
