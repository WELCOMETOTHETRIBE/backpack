...
**Source file:** `compliance/cmmc/level2/06-supporting-documents/MAC-SEC-108_MFA_Implementation_Guide.md`
...
**Related documentation (pilot):**
- **POA&M:** Deficiencies or in-progress MFA implementation are tracked in the Plan of Action and Milestones per **MAC-SOP-231** (POA&M Process Procedure). In the Trust Codex Manual, open the **POA&M** tab to view and update the IA.L2-3.5.3 item.
- **Evidence Runbook:** Operational steps to enable MFA in Microsoft Entra ID (Security Defaults, Conditional Access) and collect evidence are in **EVIDENCE_RUNBOOK.md**, section "Enable MFA in Microsoft Entra ID."
...
---
**QMS signature (SHA-256):** `f81071e7da77f45b61934bbbcf3a1804c4036bdbaac255d066ab3bafae52168d`
