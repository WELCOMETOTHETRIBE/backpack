...
- Log in to Microsoft Azure / CUI enclave VM (for environment variables)
...
### 7.1 Microsoft Azure / CUI enclave VM Environment Variables

**Access:**
- Log in to Microsoft Azure / CUI enclave VM
...
- Use Microsoft Azure / CUI enclave VM for secret management
