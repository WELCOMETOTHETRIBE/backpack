...
**Microsoft Azure / CUI enclave VM:**
...
**Platform Logs:**
- Microsoft Azure / CUI enclave VM logs infrastructure changes
- Access logged by platform
- Operations tracked
...
| Deployment Tools (other systems (outside CUI boundary)) | ✅ Full Access | ❌ No Access | Infrastructure management restricted |
