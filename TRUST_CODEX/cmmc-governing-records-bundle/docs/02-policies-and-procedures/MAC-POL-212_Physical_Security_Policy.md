...
**Infrastructure Provider:** Microsoft Azure cloud platform

**Physical Security:** Microsoft Azure provides physical security for all cloud infrastructure, including:
...
**Coverage:** All application and database infrastructure hosted on Microsoft Azure
...
**Remote Access:**
- All remote access is via HTTPS/TLS (inherited from Microsoft Azure / CUI enclave VM)
...
### 7.1 Microsoft Azure / CUI enclave VM Physical Security

**Infrastructure:** Microsoft Azure cloud platform provides physical security for all hosted infrastructure
...
**Coverage:** All application servers, databases, and infrastructure hosted on Microsoft Azure

**Evidence:** Microsoft Azure / CUI enclave VM security documentation and certifications
...
|---------|------------------|
| Cloud Infrastructure | Microsoft Azure / CUI enclave VM (inherited control) |
...
|------------|-------------|----------------|
| 3.10.1 | Limit physical access | Office security, device controls, Microsoft Azure / CUI enclave VM (inherited) |
| 3.10.2 | Protect and monitor facility | Facility protection, Microsoft Azure / CUI enclave VM (inherited) |
