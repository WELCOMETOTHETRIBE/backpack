...
|------------|-------------|----------------|
| 3.14.2 | Malicious code protection | Microsoft Azure / CUI enclave VM (inherited) + application-level protections (input validation, SQL injection prevention, XSS mitigation) |
