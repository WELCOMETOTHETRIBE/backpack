...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-100">
      ...
      >
        <h1 className="mb-4 text-xl font-semibold text-zinc-900">Create an account</h1>
        <p className="mb-4 text-sm text-zinc-500">
          Create your company profile and admin account.
        </p>
        <div className="mb-4">
          <label className="mb-1 block text-sm font-medium text-zinc-700">Organization name</label>
          <input
            type="text"
