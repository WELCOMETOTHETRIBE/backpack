...
const ROUTE_LABELS: Record<string, { section: string; title: string }> = {
  ...
  "/dashboard/governance": { section: "Assessment", title: "Governance" },
  "/dashboard/governance/controls": { section: "Governance", title: "Controls" },
  "/dashboard/technical": { section: "Infrastructure", title: "Technical" },
  "/dashboard/technical/controls": { section: "Technical", title: "Controls" },
  "/dashboard/governance/documents": { section: "Governance", title: "Document Control" },
  "/dashboard/governance/registers": { section: "Governance", title: "Registers" },
  "/dashboard/governance/evidence": { section: "Governance", title: "Evidence Library" },
  "/dashboard/governance/export": { section: "Governance", title: "Assessor Package Export" },
  "/dashboard/documents": { section: "Program", title: "Documents" },
  "/dashboard/os-baselines": { section: "Infrastructure", title: "System Boundary" },
  "/dashboard/os-baselines/scoping": { section: "System Boundary", title: "Scoping Wizard" },
