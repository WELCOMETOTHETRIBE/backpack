...
export async function calculateControlStatus(controlRecordId: string): Promise<ImplementationStatus> {
  ...
  // specific docs directly in governance_documents. Otherwise fall back to any doc linked via
  // governance_document_control_links (the manifest-bridge link table).
